...
export type UserNotification = { id: string; kind: 'inquiry_answered' | 'assignment_published' | 'assignment_due_soon' | 'assignment_commented' | 'assignment_canceled'; resourceType: string; resourceId: string; resourceVersion: number; title: string; message: string; readAt: string | null; createdAt: string };
